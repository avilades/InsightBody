...
def initialize_logger_config():
    ...
    #print(f"Configuración del logger inicializada. LOG_LEVEL: {LOG_LEVEL}, LOG_DIR: {LOG_DIR}, LOG_FILE_NAME: {LOG_FILE_NAME}, BACKUP_COUNT: {BACKUP_COUNT}, LOG_FORMAT: {LOG_FORMAT}")
