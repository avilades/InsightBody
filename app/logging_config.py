...
from config.config_json import initialize_logger_config
...
def setup_logging():
    ...
    if not os.path.exists(log_dir):
        os.makedirs(log_dir)
#    print(f"DEBUG: Directorio: {log_dir}, Archivo: {config_json.LOG_FILE_NAME}")
    # Nombre base del archivo de log
    log_base = os.path.join(log_dir, config_json.LOG_FILE_NAME)
